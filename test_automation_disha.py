...
wd = webdriver.Chrome(executable_path="C:\\Users\\Admin\\Downloads\\chromedriver.exe")
print(wd.title)
...
try:
    ...
    time.sleep(3)
    wd.find_element_by_name('Name').send_keys('Disha Pasari')
    time.sleep(3)
    wd.find_element_by_name('Email').send_keys('dishapasari2504@gmail.com')
    time.sleep(3)
